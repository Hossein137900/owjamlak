      ...
      <div className="md:w-1/2 relative">
        ...
        <motion.div className="relative z-10 bg-white/80 backdrop-blur-lg rounded-3xl p-8 shadow-2xl border border-white/30">
          ...
          >
            ...
            بهترین انتخاب رو با خیال راحت انجام بدی. از جستوجوی یه خونه ی دنج
            برای زندگی تا یه سرمایه گذاری پرسود کلان، ما بلدیم چطوری کار میکنه و
            همیشه سعی میکنیم مشاورهایی بدیم که به نفع تو باشه.
          </motion.p>
          <Link href="/services">
            <motion.button
              initial={{ opacity: 0, y: 20 }}
