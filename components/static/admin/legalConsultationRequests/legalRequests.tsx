...
const LegalRequests: React.FC = () => {
  ...
  const requests: LegalRequest[] = [
    {
      ...
      description: "نیاز به مشاوره برای تنظیم قرارداد خرید آپارتمان دارم",
      type: "Contract",
      status: "pending",
    ...
    },
    {
      ...
      phone: "09123456788",
      email: null,
      description: "مشکل حقوقی با همسایه در مورد مشاعات ساختمان دارم",
      type: "Solve",
      status: "processed",
    ...
    },
    {
      ...
      description: "نیاز به بررسی اسناد ملکی قبل از خرید دارم",
      type: "DocumentReview",
      status: "rejected",
  ...
  const handleViewRequest = (request: LegalRequest) => {
          ...
          >
            ...
            <div className="px-6 py-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                ...
                <div>
                  <p className="text-sm text-gray-500">نوع مشاوره</p>
                  <p className="font-medium">
